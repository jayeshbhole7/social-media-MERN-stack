...
class BulkOperationBase {
    ...
    // handleWriteError(callback, writeResult) {
    //     if (this.s.bulkResult.writeErrors.length > 0) {
    //       const firstError = this.s.bulkResult.writeErrors[0];
      
    //       // Check if it's a duplicate key error (code 11000) and the specific error message
    //       if (firstError.err && firstError.err.code === 11000 && firstError.err.errmsg.includes('duplicate key error')) {
    //         const duplicateKeyError = new MongoBulkWriteError({
    //           message: 'Duplicate key error',
    //           code: firstError.err.code,
    //           writeErrors: this.s.bulkResult.writeErrors
    //         }, writeResult);
      
    //         callback(duplicateKeyError);
    //         return true;
    //       }
      
    //       const msg = firstError.err && firstError.err.errmsg ? firstError.err.errmsg : 'Write operation failed';
      
    //       const error = new MongoBulkWriteError({
    //         message: msg,
    //         code: firstError.err ? firstError.err.code : 0,
    //         writeErrors: this.s.bulkResult.writeErrors
    //       }, writeResult);
